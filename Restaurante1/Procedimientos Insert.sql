...
/* PROCEDIMIENTO INSERTAR SUCURSAL */
...
as
Begin
	insert into empleados(id_empleados,nombres,apellidos,id_sucursal,id_tipo_empleo,id_cargo,salario,telefono)
	values(@id_empleados,@nombres,@apellidos,@id_sucursal,@id_tipo_empleo,@id_cargo,@salario,@telefono)
End
...
/* PROCEDIMIENTO INSERTAR RESERVACIONES */
...
as
Begin
	insert into reservaciones(id_reserva,id_cliente,fecha,hora)
	values(@id_reserva,@id_cliente,@fecha,@hora)
End

/* PROCEDIMIENTO MESAS RESERVADAS */
...
/* PROCEDIMIENTO INSERTAR ORDENES */
...
/* PROCEDIMIENTO INSERTAR FORMA DE PAGO */
...
/* PROCEDIMIENTO INSERTAR FACTURAS */
...
/* PROCEDIMIENTO INSERTAR ORDENES FACTURADAS */
...
/* PROCEDIMIENTO INSERTAR REGISTRO JORNADA */
